      ...
      <main className="flex-1 pt-28 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6 flex items-start justify-between flex-wrap gap-4">
            <div>
              <h1 className="font-display text-3xl md:text-4xl uppercase text-foreground tracking-wider">Pitch Bookings</h1>
              <p className="text-sm text-muted-foreground mt-1">Reserve a pitch at the PAFC ground. All bookings need approval by an admin or fixture secretary.</p>
            </div>
          ...
          {tab === "map" && (
            <>
              ...
              <div className="mt-6 space-y-2">
                <h2 className="font-display uppercase tracking-wider text-sm text-foreground mb-3">Bookings on {format(parseISO(selectedDate), "EEE dd MMM")}</h2>
