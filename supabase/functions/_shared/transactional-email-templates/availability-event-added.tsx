  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Head to the PAFC Hub to confirm whether you're available.
        </Text>
...
export const template = {
  ...
  previewData: { eventTitle: 'Friendly vs Manor FC', eventDate: '20 Apr 2026', eventTime: '10:00', venue: 'Yaxley FC', teamName: 'U10 Lions' },
