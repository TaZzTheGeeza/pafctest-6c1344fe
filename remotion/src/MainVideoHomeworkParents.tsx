...
const FootageScene: React.FC<BaseSceneProps & { video: string; align?: "left" | "right" }> = ({ video, align = "left", ...text }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#050505", overflow: "hidden" }}>
      <OffthreadVideo src={staticFile(`video/homework-parent/${video}`)} muted style={{ width: "100%", height: "100%", objectFit: "cover", transform: `scale(${zoom})` }} />
...
const Intro: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#050505", overflow: "hidden" }}>
      <OffthreadVideo src={staticFile("video/homework-parent/proud-finish.mp4")} muted style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.68, transform: `scale(${1 + frame / 6500})` }} />
